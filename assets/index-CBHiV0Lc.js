 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class nh{constructor(t,e){this.name=t,this.container=e,this.component=null,this.instances=new Map,this.instancesDeferred=new Map,this.instancesOptions=new Map,this.onInitCallbacks=new Map}get(t){const e=this.normalizeInstanceIdentifier(t);if(!this.instancesDeferred.has(e)){const r=new ju;if(this.instancesDeferred.set(e,r),this.isInitialized(e)||this.shouldAutoInitialize())try{const s=this.getOrInitializeService({instanceIdentifier:e});s&&r.resolve(s)}catch{}}return this.instancesDeferred.get(e).promise}getImmediate(t){var e;const r=this.normalizeInstanceIdentifier(t==null?void 0:t.identifier),s=(e=t==null?void 0:t.optional)!==null&&e!==void 0?e:!1;if(this.isInitialized(r)||this.shouldAutoInitialize())try{return this.getOrInitializeService({instanceIdentifier:r})}catch(o){if(s)return null;throw o}else{if(s)return null;throw Error(`Service ${this.name} is not available`)}}getComponent(){return this.component}setComponent(t){if(t.name!==this.name)throw Error(`Mismatching Component ${t.name} for Provider ${this.name}.`);if(this.component)throw Error(`Component for ${this.name} has already been provided`);if(this.component=t,!!this.shouldAutoInitialize()){if(sh(t))try{this.getOrInitializeService({instanceIdentifier:Ie})}catch{}for(const[e,r]of this.instancesDeferred.entries()){const s=this.normalizeInstanceIdentifier(e);try{const o=this.getOrInitializeService({instanceIdentifier:s});r.resolve(o)}catch{}}}}clearInstance(t=Ie){this.instancesDeferred.delete(t),this.instancesOptions.delete(t),this.instances.delete(t)}async delete(){const t=Array.from(this.instances.values());await Promise.all([...t.filter(e=>"INTERNAL"in e).map(e=>e.INTERNAL.delete()),...t.filter(e=>"_delete"in e).map(e=>e._delete())])}isComponentSet(){return this.component!=null}isInitialized(t=Ie){return this.instances.has(t)}getOptions(t=Ie){return this.instancesOptions.get(t)||{}}initialize(t={}){const{options:e={}}=t,r=this.normalizeInstanceIdentifier(t.instanceIdentifier);if(this.isInitialized(r))throw Error(`${this.name}(${r}) has already been initialized`);if(!this.isComponentSet())throw Error(`Component ${this.name} has not been registered yet`);const s=this.getOrInitializeService({instanceIdentifier:r,options:e});for(const[o,a]of this.instancesDeferred.entries()){const l=this.normalizeInstanceIdentifier(o);r===l&&a.resolve(s)}return s}onInit(t,e){var r;const s=this.normalizeInstanceIdentifier(e),o=(r=this.onInitCallbacks.get(s))!==null&&r!==void 0?r:new Set;o.add(t),this.onInitCallbacks.set(s,o);const a=this.instances.get(s);return a&&t(a,s),()=>{o.delete(t)}}invokeOnInitCallbacks(t,e){const r=this.onInitCallbacks.get(e);if(r)for(const s of r)try{s(t,e)}catch{}}getOrInitializeService({instanceIdentifier:t,options:e={}}){let r=this.instances.get(t);if(!r&&this.component&&(r=this.component.instanceFactory(this.container,{instanceIdentifier:rh(t),options:e}),this.instances.set(t,r),this.instancesOptions.set(t,e),this.invokeOnInitCallbacks(r,t),this.component.onInstanceCreated))try{this.component.onInstanceCreated(this.container,t,r)}catch{}return r||null}normalizeInstanceIdentifier(t=Ie){return this.component?this.component.multipleInstances?t:Ie:t}shouldAutoInitialize(){return!!this.component&&this.component.instantiationMode!=="EXPLICIT"}}function rh(n){return n===Ie?void 0:n}function sh(n){return n.instantiationMode==="EAGER"}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const sd="firebase-heartbeat-database",id=1,Dn="firebase-heartbeat-store";let Ds=null;function cc(){return Ds||(Ds=_h(sd,id,{upgrade:(n,t)=>{switch(t){case 0:try{n.createObjectStore(Dn)}catch(e){console.warn(e)}}}}).catch(n=>{throw ie.create("idb-open",{originalErrorMessage:n.message})})),Ds}async function od(n){try{const e=(await cc()).transaction(Dn),r=await e.objectStore(Dn).get(lc(n));return await e.done,r}catch(t){if(t instanceof Ye)Qt.warn(t.message);else{const e=ie.create("idb-get",{originalErrorMessage:t==null?void 0:t.message});Qt.warn(e.message)}}}async function Xo(n,t){try{const r=(await cc()).transaction(Dn,"readwrite");await r.objectStore(Dn).put(t,lc(n)),await r.done}catch(e){if(e instanceof Ye)Qt.warn(e.message);else{const r=ie.create("idb-set",{originalErrorMessage:e==null?void 0:e.message});Qt.warn(r.message)}}}function lc(n){return`${n.name}!${n.options.appId}`}/**
 * @license
 * Copyright 2021 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Ma="PersistentStream";class ul{constructor(t,e,r,s,o,a,l,h){this.Fi=t,this.w_=r,this.S_=s,this.connection=o,this.authCredentialsProvider=a,this.appCheckCredentialsProvider=l,this.listener=h,this.state=0,this.b_=0,this.D_=null,this.v_=null,this.stream=null,this.C_=0,this.F_=new ll(t,e)}M_(){return this.state===1||this.state===5||this.x_()}x_(){return this.state===2||this.state===3}start(){this.C_=0,this.state!==4?this.auth():this.O_()}async stop(){this.M_()&&await this.close(0)}N_(){this.state=0,this.F_.reset()}B_(){this.x_()&&this.D_===null&&(this.D_=this.Fi.enqueueAfterDelay(this.w_,6e4,(()=>this.L_())))}k_(t){this.q_(),this.stream.send(t)}async L_(){if(this.x_())return this.close(0)}q_(){this.D_&&(this.D_.cancel(),this.D_=null)}Q_(){this.v_&&(this.v_.cancel(),this.v_=null)}async close(t,e){this.q_(),this.Q_(),this.F_.cancel(),this.b_++,t!==4?this.F_.reset():e&&e.code===C.RESOURCE_EXHAUSTED?(Xt(e.toString()),Xt("Using maximum backoff delay to prevent overloading the backend."),this.F_.f_()):e&&e.code===C.UNAUTHENTICATED&&this.state!==3&&(this.authCredentialsProvider.invalidateToken(),this.appCheckCredentialsProvider.invalidateToken()),this.stream!==null&&(this.U_(),this.stream.close(),this.stream=null),this.state=t,await this.listener.n_(e)}U_(){}auth(){this.state=1;const t=this.K_(this.b_),e=this.b_;Promise.all([this.authCredentialsProvider.getToken(),this.appCheckCredentialsProvider.getToken()]).then((([r,s])=>{this.b_===e&&this.W_(r,s)}),(r=>{t((()=>{const s=new M(C.UNKNOWN,"Fetching auth token failed: "+r.message);return this.G_(s)}))}))}W_(t,e){const r=this.K_(this.b_);this.stream=this.z_(t,e),this.stream.Zo((()=>{r((()=>this.listener.Zo()))})),this.stream.e_((()=>{r((()=>(this.state=2,this.v_=this.Fi.enqueueAfterDelay(this.S_,1e4,(()=>(this.x_()&&(this.state=3),Promise.resolve()))),this.listener.e_())))})),this.stream.n_((s=>{r((()=>this.G_(s)))})),this.stream.onMessage((s=>{r((()=>++this.C_==1?this.j_(s):this.onNext(s)))}))}O_(){this.state=5,this.F_.g_((async()=>{this.state=0,this.start()}))}G_(t){return x(Ma,`close with error: ${t}`),this.stream=null,this.close(4,t)}K_(t){return e=>{this.Fi.enqueueAndForget((()=>this.b_===t?e():(x(Ma,"stream callback skipped by getCloseGuardedDispatcher."),Promise.resolve())))}}}class vm extends ul{constructor(t,e,r,s,o,a){super(t,"listen_stream_connection_backoff","listen_stream_idle","health_check_timeout",e,r,s,a),this.serializer=o}z_(t,e){return this.connection.P_("Listen",t,e)}j_(t){return this.onNext(t)}onNext(t){this.F_.reset();const e=Rf(this.serializer,t),r=(function(o){if(!("targetChange"in o))return F.min();const a=o.targetChange;return a.targetIds&&a.targetIds.length?F.min():a.readTime?Ut(a.readTime):F.min()})(t);return this.listener.J_(e,r)}H_(t){const e={};e.database=Js(this.serializer),e.addTarget=(function(o,a){let l;const h=a.target;if(l=Gs(h)?{documents:Cf(o,h)}:{query:Vf(o,h).Vt},l.targetId=a.targetId,a.resumeToken.approximateByteSize()>0){l.resumeToken=Yc(o,a.resumeToken);const d=Ws(o,a.expectedCount);d!==null&&(l.expectedCount=d)}else if(a.snapshotVersion.compareTo(F.min())>0){l.readTime=Or(o,a.snapshotVersion.toTimestamp());const d=Ws(o,a.expectedCount);d!==null&&(l.expectedCount=d)}return l})(this.serializer,t);const r=kf(this.serializer,t);r&&(e.labels=r),this.k_(e)}Y_(t){const e={};e.database=Js(this.serializer),e.removeTarget=t,this.k_(e)}}class Tm extends ul{constructor(t,e,r,s,o,a){super(t,"write_stream_connection_backoff","write_stream_idle","health_check_timeout",e,r,s,a),this.serializer=o}get Z_(){return this.C_>0}start(){this.lastStreamToken=void 0,super.start()}U_(){this.Z_&&this.X_([])}z_(t,e){return this.connection.P_("Write",t,e)}j_(t){return W(!!t.streamToken,31322),this.lastStreamToken=t.streamToken,W(!t.writeResults||t.writeResults.length===0,55816),this.listener.ea()}onNext(t){W(!!t.streamToken,12678),this.lastStreamToken=t.streamToken,this.F_.reset();const e=Pf(t.writeResults,t.commitTime),r=Ut(t.commitTime);return this.listener.ta(r,e)}na(){const t={};t.database=Js(this.serializer),this.k_(t)}X_(t){const e={streamToken:this.lastStreamToken,writes:t.map((r=>Sf(this.serializer,r)))};this.k_(e)}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Pl{constructor(t){this.observer=t,this.muted=!1}next(t){this.muted||this.observer.next&&this.xu(this.observer.next,t)}error(t){this.muted||(this.observer.error?this.xu(this.observer.error,t):Xt("Uncaught Error in snapshot listener:",t.toString()))}Ou(){this.muted=!0}xu(t,e){setTimeout((()=>{this.muted||t(e)}),0)}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 */ze(Rp,Sp,"app");const Pp={apiKey:"AIzaSyCERd9rAdFL4j55BG_6q1sFebMBPlQV0Kk",authDomain:"ghino-86139.firebaseapp.com",projectId:"ghino-86139",storageBucket:"ghino-86139.firebasestorage.app",messagingSenderId:"251610009825",appId:"1:251610009825:web:584a352bd985e5b5e3e7a0",measurementId:"G-MGGWZS4FDM"},Cp=ac(Pp),rs=up(Cp),si=es(rs,"ghino","main"),ql=es(rs,"ghino","score"),zl=es(rs,"ghino","audit"),Hl=es(rs,"ghino","passwords"),Ct=["Mạnh","Hùng","Tú","Duy","Trâm"],Ae={manh:"Mạnh",hung:"Hùng",tu:"Tú",duy:"Duy",tram:"Trâm"};function ct(n){return!n&&n!==0?"0đ":Math.round(n).toLocaleString("vi-VN")+"đ"}function rt(n,t){const e=document.getElementById("toast");e&&(e.textContent=n,e.style.background=t?"var(--accent2)":"var(--accent3)",e.style.color="#111",e.classList.add("show"),setTimeout(()=>e.classList.remove("show"),2500))}function Gl(n,t=800,e=800,r=.7){return new Promise((s,o)=>{const a=new FileReader;a.readAsDataURL(n),a.onload=l=>{const h=new Image;h.src=l.target.result,h.onload=()=>{const d=document.createElement("canvas");let m=h.width,E=h.height;m>E?m>t&&(E=Math.round(E*t/m),m=t):E>e&&(m=Math.round(m*e/E),E=e),d.width=m,d.height=E,d.getContext("2d").drawImage(h,0,0,m,E);const S=d.toDataURL("image/jpeg",r);s(S)},h.onerror=d=>o(d)},a.onerror=l=>o(l)})}const R={db:{transactions:[],settlements:[]},dbReady:!1,currentUser:null,auditLog:[],scorePlayers:[{id:crypto.randomUUID(),name:"Hùng",score:0},{id:crypto.randomUUID(),name:"Duy",score:0},{id:crypto.randomUUID(),name:"Mạnh",score:0},{id:crypto.randomUUID(),name:"Tú",score:0}],scoreHistory:[],accounts:{manh:"123",hung:"123",tu:"123",duy:"123",tram:"123"},cardMode:"532",cardSlotSelection:{50:[],30:[],20:[],40:[],"30b":[],"20b":[],10:[]},foodSelected:[...Ct],foodPurpose:"",randomPlayers:["Tú","Mạnh","Hùng","Duy","Trâm"],currentRotation:0};function qe(n,t=!0){const e=document.getElementById("sync-status");e&&(e.textContent=n,e.style.color=t?"var(--accent3)":"var(--accent2)")}async function rn(n){R.db=n;try{await ns(si,n),qe("✔ Đã lưu")}catch(t){qe("✘ Lỗi lưu: "+t.message,!1)}}async function Vp(){try{const n=await Ui(zl);n.exists()&&(R.auditLog=n.data().log||[])}catch{R.auditLog=[]}}async function ii(n){R.auditLog.push(n);try{await ns(zl,{log:R.auditLog})}catch(t){console.error("Lỗi khi lưu audit log:",t)}}function ye(n,t=""){if(!R.currentUser||["score_add","score_undo","score_delete","score_reset"].includes(n))return;const e={id:crypto.randomUUID(),user:R.currentUser,userLabel:Ae[R.currentUser],type:n,detail:t,ts:Date.now(),date:new Date().toISOString()};return ii(e),e}const Dp={login:{icon:"🔑",label:"Đăng nhập",color:"#4ae8a0"},login_fail:{icon:"❌",label:"Đăng nhập thất bại",color:"#e84a4a"},logout:{icon:"🚪",label:"Đăng xuất",color:"#888"},change_password:{icon:"🔒",label:"Đổi mật khẩu",color:"#9a4ae8"},save_food:{icon:"💵",label:"Lưu chia tiền",color:"#e8c84a"},save_card:{icon:"🃏",label:"Lưu đánh bài",color:"#e89a4a"},settle:{icon:"✅",label:"Thanh toán nợ",color:"#4a9ae8"},delete_tx:{icon:"🗑",label:"Xóa giao dịch",color:"#e84a4a"}};function oi(){var o,a;const n=((o=document.getElementById("audit-filter-user"))==null?void 0:o.value)||"",t=((a=document.getElementById("audit-filter-type"))==null?void 0:a.value)||"";let e=[...R.auditLog].reverse();n&&(e=e.filter(l=>l.user===n)),t&&(e=e.filter(l=>l.type===t));const r=document.getElementById("audit-count");r&&(r.textContent=e.length+" sự kiện");const s=document.getElementById("audit-list");if(s){if(e.length===0){s.innerHTML='<div class="empty">Không có dữ liệu</div>';return}s.innerHTML=e.map(l=>{const h=Dp[l.type]||{icon:"•",label:l.type,color:"#888"},m=new Date(l.ts).toLocaleString("vi-VN",{day:"2-digit",month:"2-digit",hour:"2-digit",minute:"2-digit",second:"2-digit"});return`
  ...
  `).join(""),n.querySelectorAll(".score-player").forEach(t=>{const e=t.getAttribute("data-id"),r=t.querySelector(".score-add"),s=t.querySelector(".score-name"),o=t.querySelector(".score-total");t.onclick=a=>{R.scoreDeleteMode&&a.target!==r&&a.target!==s&&a.target!==o&&Yp(e)},r.onkeydown=a=>{a.key==="Enter"&&r.blur()},r.onblur=()=>{Kp(e,r)},s.onchange=()=>{Wp(e,s.value)},o.onchange=()=>{Qp(e,o.value)}}),tg())}async function Kp(n,t){const e=parseInt(t.value);if(isNaN(e)){t.value="";return}const r=R.scorePlayers.find(s=>s.id===n);r&&(r.score+=e,R.scoreHistory.push({type:"add",entryId:crypto.randomUUID(),id:n,value:e,date:Date.now()}),ye("score_add",`+${e} cho ${r.name}`),t.value="",await xe(),ge(),window.dispatchEvent(new CustomEvent("scoreUpdated")))}async function Wp(n,t){const e=R.scorePlayers.find(r=>r.id===n);e&&(e.name=t,await xe(),window.dispatchEvent(new CustomEvent("scoreUpdated")))}async function Qp(n,t){const e=R.scorePlayers.find(s=>s.id===n);if(!e)return;const r=parseInt(t);isNaN(r)||(e.score=r,await xe())}async function Xp(){R.scorePlayers.push({id:crypto.randomUUID(),name:"New",score:0}),await xe(),ge(),window.dispatchEvent(new CustomEvent("scoreUpdated"))}function Jp(){R.scoreDeleteMode=!R.scoreDeleteMode;const n=document.getElementById("score-delete-btn");n&&(n.style.opacity=R.scoreDeleteMode?"1":"0.6"),ge()}async function Yp(n){R.scoreDeleteMode&&Xl()&&confirm("Xóa người này?")&&(R.scorePlayers=R.scorePlayers.filter(t=>t.id!==n),R.scoreHistory=R.scoreHistory.filter(t=>t.id!==n),await xe(),ge(),window.dispatchEvent(new CustomEvent("scoreUpdated")))}function Xl(){const n=prompt("Nhập mật khẩu tài khoản của bạn:");return!R.currentUser||R.accounts[R.currentUser]!==n?(rt("Sai mật khẩu!",!0),!1):!0}async function Zp(n){const t=R.scoreHistory.find(s=>s.entryId===n);if(!t||R.scoreHistory.some(s=>s.type==="undo"&&s.target===n))return;const r=R.scorePlayers.find(s=>s.id===t.id);r&&(r.score-=t.value),R.scoreHistory.push({type:"undo",target:n,id:t.id,value:t.value,date:Date.now()}),await xe(),ge(),window.dispatchEvent(new CustomEvent("scoreUpdated"))}function tg(){const n=document.getElementById("score-history");if(!n)return;const t=R.scoreHistory.filter(s=>s.type==="add"||!s.type),e=new Set(R.scoreHistory.filter(s=>s.type==="delete").map(s=>s.target)),r=new Set(R.scoreHistory.filter(s=>s.type==="undo").map(s=>s.target));if(t.length===0){n.innerHTML='<div class="empty">Chưa có lịch sử</div>';return}n.innerHTML=t.slice().reverse().map(s=>{const o=R.scorePlayers.find(g=>g.id===s.id),a=e.has(s.entryId),l=r.has(s.entryId);let h="";a?h=`<span style="font-family:'IBM Plex Mono',monospace;font-size:0.65rem;color:var(--accent2);margin-left:6px;">DELETED</span>`:l&&(h=`<span style="font-family:'IBM Plex Mono',monospace;font-size:0.65rem;color:var(--muted);margin-left:6px;">↩ UNDONE</span>`);const d=a||l?"text-decoration:line-through;opacity:0.4;":"";let m='<span style="width:62px;display:inline-block;"></span>';!a&&!l&&(m=`<button class="btn btn-ghost score-undo-btn" style="font-size:0.7rem;padding:5px 10px;color:var(--muted);" data-entry-id="${s.entryId}">↩ Undo</button>`);const E=s.date?new Date(s.date).toLocaleTimeString("vi-VN",{hour:"2-digit",minute:"2-digit"}):"";return`
    ...
    `}).join(""),n.querySelectorAll(".score-undo-btn").forEach(s=>{s.onclick=()=>{const o=s.getAttribute("data-entry-id");Zp(o)}})}async function eg(){Xl()&&confirm("Reset toàn bộ điểm và lịch sử?")&&(ye("score_reset","Reset toàn bộ điểm và lịch sử"),R.scorePlayers=[],R.scoreHistory=[],await xe(),ge(),window.dispatchEvent(new CustomEvent("scoreUpdated")))}function Hn(){const n=document.getElementById("random-list");n&&(n.innerHTML=R.randomPlayers.map((t,e)=>`
